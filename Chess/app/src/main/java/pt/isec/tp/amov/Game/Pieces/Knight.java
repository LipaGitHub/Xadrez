...
public class Knight extends Piece {
    ...
    public void move(Player p){
        ...
        if(peca.getY()-1 >= 0 && peca.getY()-1 <= 7) possibilidades.add((peca.getX()-2)*8+peca.getY()-1);
        if(peca.getY()+1 >= 0 && peca.getY()+1 <= 7) possibilidades.add((peca.getX()-2)*8+peca.getY()+1);
        if(peca.getY()-2 >= 0 && peca.getY()-2 <= 7) possibilidades.add((peca.getX()-1)*8+peca.getY()-2);
        if(peca.getY()+2 >= 0 && peca.getY()+2 <= 7) possibilidades.add((peca.getX()-1)*8+peca.getY()+2);
        if(peca.getY()-2 >= 0 && peca.getY()-2 <= 7) possibilidades.add((peca.getX()+1)*8+peca.getY()-2);
        if(peca.getY()+2 >= 0 && peca.getY()+2 <= 7) possibilidades.add((peca.getX()+1)*8+peca.getY()+2);
        if(peca.getY()-1 >= 0 && peca.getY()-1 <= 7) possibilidades.add((peca.getX()+2)*8+peca.getY()-1);
